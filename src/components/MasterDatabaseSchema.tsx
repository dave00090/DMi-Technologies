  ...
  const masterTables: SchemaItem[] = [
    {
      ...
      sql: `CREATE TABLE public.licenses (
...
-- Standard Select policy allowing public access for key checks (Node verification)
CREATE POLICY "Allow public select for active checks" ON public.licenses 
    FOR SELECT USING (true);

-- Allow Master Admin inserts & edits
...
CREATE POLICY "Allow Master reading of metrics" ON public.sales 
    ...
    },
    {
      ...
      sql: `CREATE TABLE public.piracy_alerts (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    business_id VARCHAR(255),
    license_key VARCHAR(255) NOT NULL,
    alert_type VARCHAR(100) NOT NULL, -- 'CASH_DRAWER_KICK', 'TAMPER', 'HARDWARE_CLONE'
...
CREATE POLICY "Allow Master alerts monitoring" ON public.piracy_alerts 
    ...
    },
    {
      ...
      sql: `CREATE TABLE public.login_history (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE POLICY "Allow audit inspection" ON public.login_history 
    ...
    },
    {
      ...
      sql: `CREATE TABLE public.cloud_sync_state (
...
CREATE TABLE guest_requests (
    ...
    },
    {
      ...
      sql: `CREATE TABLE customer_debts (
    id VARCHAR(255) PRIMARY KEY,
    business_id VARCHAR(255) REFERENCES businesses(id) ON DELETE CASCADE,
    shop_id VARCHAR(255) REFERENCES shops(id) ON DELETE CASCADE,
